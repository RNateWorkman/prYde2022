...
import fs from "fs";
//import { startCreating, buildSetup } from './artGeneration';
    ...
    <s.Screen>
      <Particles id="tsparticles" options={options} init={initialize}/>
        ...
        >
          ...
          <s.SpacerLarge />
          <Fade delay="300" cascade="true" damping="2">
          <s.Container
            flex={2}
            jc={"center"}
            ai={"center"}
        ...
        <s.SpacerMedium />
        <s.Container jc={"center"} ai={"center"} style={{ width: "70%", backgroundColor: "var(--accent)"}}>
          <s.TextDescription
            style={{
              textAlign: "center",
              color: "var(--primary-text)",
          ...
          <s.SpacerSmall />
                <StyledDiscordLink target={"_blank"} href="https://discord.gg/cAedkcRkct">
                  JOIN OUR DISCORD
                </StyledDiscordLink>
        </s.Container>
      </s.Container>
